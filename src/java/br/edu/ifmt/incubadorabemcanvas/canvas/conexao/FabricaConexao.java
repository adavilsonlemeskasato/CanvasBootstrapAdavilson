package br.edu.ifmt.incubadorabemcanvas.canvas.conexao;
...
public class FabricaConexao {
    ...
    private static final String URL_CONEXAO = "jdbc:postgresql://localhost:5432/Incubadora Ben Canvas";
    private static final String USUARIO = "postgres";
    private static final String SENHA = "3636";
